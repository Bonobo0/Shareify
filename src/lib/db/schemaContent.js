...
// This file contains the inlined SQL schema to avoid file system dependencies in serverless environments (e.g., Vercel)
// Original schema source: src/lib/db/schema.sql

export const SCHEMA_SQL = `-- PostgreSQL Schema for Shareify
